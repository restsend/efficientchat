<template>
  <div class="bottomBar">
    <div class="left">
      <wacrm-aside :asideNameIndex="asideNameIndex" @asideName="asideName" />
    </div>
    ...
    >
      <el-submenu index="2">
        ...
        <el-menu-item index="2-1">
          <a
            href="https://api.whatsapp.com/send?phone=+8618649314020&text=I'm%20an%20EfficientChat%20customer%20with%20a%20question."
            style="color: #909399"
            target="_blank"
            >✨ Contact us 🔥</a
          >
        ...
        <el-menu-item index="2-2"
          ><a :href="aboutLink" style="color: #909399" target="_blank"
            >❤️ About EfficientChat 😃</a
          ></el-menu-item
        >
      </el-submenu>
    </el-menu>
...
import fastreplyBox from "../fastreply/fastreply-box.vue";
export default {
  components: { fastreplyBox, WacrmAside },
  name: "bottomBar",
